...
public class TelaAvisoSelecioneFuncionario extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaAvisoSelecioneFuncionario frame = new TelaAvisoSelecioneFuncionario();
	 ...
	 * Create the frame.
	 */
	public TelaAvisoSelecioneFuncionario() {
		...
		JLabel lblNewLabel = new JLabel("Selecione um funcionario!");
