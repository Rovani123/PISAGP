...
public class TelaFuncionárioCadastroProduto extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaFuncionárioCadastroProduto frame = new TelaFuncionárioCadastroProduto();
	 ...
	 * Create the frame.
	 */
	public TelaFuncionárioCadastroProduto() {
