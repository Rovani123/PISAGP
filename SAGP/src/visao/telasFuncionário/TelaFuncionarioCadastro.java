...
public class TelaFuncionarioCadastro extends JFrame {
	...
	public TelaFuncionarioCadastro() {
		...
		contentPane.add(lblNewLabel, "cell 3 2 8 1,alignx center,growy");
		
		JLabel lblNewLabel_1 = new JLabel("CRIE UMA CONTA:");
		contentPane.add(lblNewLabel_1, "cell 3 4 7 1,alignx center");
		...
		contentPane.add(txtEntreComSeu, "cell 4 5 6 1,growx");
		...
		contentPane.add(txtEntreComSeu_1, "cell 4 7 6 1,growx");
		...
		contentPane.add(btnNewButton_5, "cell 10 7");
		...
		contentPane.add(txtEntreComUma, "cell 4 9 6 1,growx");
		...
		contentPane.add(btnNewButton_1, "cell 10 9");
		...
		contentPane.add(btnNewButton_3, "cell 10 11");
	}
