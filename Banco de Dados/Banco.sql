CREATE DATABASE  IF NOT EXISTS `bsagp` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `bsagp`;
...
INSERT INTO `funcionarios` VALUES (1,'Lucas','Jesus','adm69',1),(2,'Lucas','Lucas_Ir','funcpadaria',0),(3,'Douglas','omelhorfurtador','funcpadaria',0),(4,'Daniela','Daniela','funcpadaria',0);
...
INSERT INTO `produtos` VALUES (1,'Coxinha',5.00,10,'salgados'),(2,'Pastel de carne',6.00,10,'salgados'),(3,'Pastel de pizza',6.00,10,'salgados'),(4,'Bolo',10.00,15,'doces'),(5,'Donut',12.00,15,'doces'),(6,'Coca-Cola',10.00,5,'bebidas'),(7,'Guarana',9.00,7,'bebidas'),(8,'Fanta',7.00,5,'bebidas'),(9,'Nega Maluca',40.00,5,'bolos');
...
CREATE TABLE `produtospromocao` (
  `idProdutosPromocao` int(11) NOT NULL AUTO_INCREMENT,
  `idProduto` int(11) NOT NULL,
...
INSERT INTO `vendas` VALUES (1,1,1,'cr?dito'),(2,2,2,'d?bito'),(3,3,2,'pix');
...
-- Dump completed on 2024-11-05 11:39:59
